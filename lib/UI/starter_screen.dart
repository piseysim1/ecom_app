import 'package:e_comapp/UI/create_account_screen.dart';
      ...
      Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20,),
            Text("Shoope", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold),),
            SizedBox(height: 20,),
            Text("Beautiful eCommerce UI Kit \n for your online store",textAlign: TextAlign.center,),
            SizedBox(height: 40,),
            SizedBox(
              width: 320,
              height: 50,
