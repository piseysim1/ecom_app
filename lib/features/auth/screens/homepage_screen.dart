import 'package:e_comapp/features/auth/widgets/components/categories_item.dart';
import 'package:e_comapp/features/auth/widgets/components/flash_sale.dart';
import 'package:e_comapp/features/auth/widgets/components/justforyou.dart';
import 'package:e_comapp/features/auth/widgets/components/most_popular.dart';
import 'package:e_comapp/features/auth/widgets/components/new_item.dart';
import 'package:e_comapp/features/auth/widgets/components/topproduct.dart';
...
import 'package:e_comapp/features/auth/widgets/circle_button_widget.dart';
import 'package:e_comapp/features/auth/widgets/headertitle.dart';
import 'package:e_comapp/features/auth/widgets/profile_widget.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          spacing: 16,
          children: [
            ProfileWidget(width: 28, height: 30, imageUrl: "https://tse3.mm.bing.net/th/id/OIP.L_fHNhGC_83eIzFgtkiBHAHaEK?rs=1&pid=ImgDetMain&o=7&rm=3",),
            Chip(
